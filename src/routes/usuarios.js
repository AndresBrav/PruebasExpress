...
// Middleware para verificar si el archivo 'usuarios.json' existe
rutasUsuarios.use(verificarArchivo); // Esto se ejecuta antes de las rutas
...
rutasUsuarios.put('/usuarios/:id', (req, res) => {
...
rutasUsuarios.post('/usuarios', (req, res) => {
    let usuarios = leerUsuarios(); // Leer usuarios actuales
...
rutasUsuarios.delete('/usuarios/:id', (req, res) => {
    let usuarios = leerUsuarios(); // Leer usuarios actuales desde el archivo
